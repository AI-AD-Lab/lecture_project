...
def main():
    ...
    seghead_adaptive_patch_model_weight_chekpoint = {
        'vit_h': './ckpts_ap_canny/260108/vit_h_best_val.pth',
        'vit_l': './ckpts_ap_canny/260108/vit_l_best_val.pth',
        'vit_b': './ckpts_ap_canny/260111/vit_b_best_val.pth',
        'vits': './ckpts_ap_canny/260108/vits_best_val.pth',
        'vitt': './ckpts_ap_canny/260108/vitt_best_val.pth',  
    }
