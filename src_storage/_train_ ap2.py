...
class adaptive_patch_orfd_model(nn.Module):

    def __init__(self, sam_model, decoder, model_type='vits', boundary_thresh=0.0):
        ...
        embed_dim = self.variant2ch[model_type]
    ...
    def forward(self, x):
        ...
        # 1) backbone feature
        feats = self.sam_model(x)  # [B,384,h,w], h=H/16, w=W/16
        _, C, h, w = feats.shape
