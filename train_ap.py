...
from efficient_sam_adaptive_patch.build_efficient_sam import build_efficient_sam_vits
    ...
    for epoch in range(1, epochs+1):
        ...
        if (epoch % val_every) == 0: 
            ...
            if mean_iou > best_val_iou:
                ...
                torch.save(ckpt, f"ckpts/best_{model_type_name}_ap_vits_1202.pth")
...
def main():
    ...
    sam_model_weight_chekpoint = {
        ...
        'vits': './weights/adaptive_efficient_sam.pth',
